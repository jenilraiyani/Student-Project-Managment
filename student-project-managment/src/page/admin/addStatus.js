...
const AddStatus = () => {
  ...
  const [taskStatusCssClass, setTaskStatusCssClass] = useState('primary');
  ...
  const handleSave = async (e) => {
    ...
    const newStatus = {
      ...
      taskStatusCssClass: taskStatusCssClass
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to save the status');
        alert('Failed to save the status. Please try again.');
      }
    } catch (error) {
  ...
  const currentColors = getColorForClass(taskStatusCssClass);
    ...
    <>
      <div className="container-fluid p-0">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <h4 className="fw-bold mb-1 text-dark" style={{ letterSpacing: '-0.5px' }}>Add Status</h4>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0" style={{ fontSize: '0.85rem' }}>
                ...
                <li className="breadcrumb-item"><a href="#" className="text-decoration-none text-muted">Status</a></li>
        ...
        <div className="card spms-premium-card border-0">
          <div className="card-body p-4 p-md-5">
            ...
            <h6 className="fw-bold text-dark mb-4 pb-2 border-bottom">Status Details</h6>

            <form onSubmit={handleSave}>
              
              <div className="row mb-4 align-items-center">
                <label htmlFor="statusName" className="col-sm-3 col-form-label fw-semibold text-secondary">
              ...
              <div className="row mb-4 align-items-center">
                ...
                <div className="col-sm-9 col-lg-6">
                  <select 
                    ...
                    id="cssClass"
                    value={taskStatusCssClass}
                    onChange={(e) => setTaskStatusCssClass(e.target.value)}
                    required
                  >
