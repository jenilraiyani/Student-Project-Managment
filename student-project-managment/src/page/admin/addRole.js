...
const AddRole = () => {
  ...
  // Updated to an async function to handle the API call
  const handleSave = async (e) => {
    ...
    try {
      const response = await fetch('https://student-project-managment.onrender.com/api/Role', {
        method: 'POST',
      ...
      if (response.ok) {
        ...
        console.error("Failed to save the role");
    ...
    <>
      ...
      <div className="container-fluid p-0">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <h4 className="fw-bold mb-1 text-dark" style={{ letterSpacing: '-0.5px' }}>Add Role</h4>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0" style={{ fontSize: '0.85rem' }}>
                <li className="breadcrumb-item"><a href="#" className="text-decoration-none text-muted">Home</a></li>
                <li className="breadcrumb-item"><a href="#" className="text-decoration-none text-muted">Roles</a></li>
        ...
        <div className="card spms-premium-card border-0">
          <div className="card-body p-4 p-md-5">
            ...
            <h6 className="fw-bold text-dark mb-4 pb-2 border-bottom">Role Details</h6>

            <form onSubmit={handleSave}>
              
              
              <div className="row mb-4 align-items-center">
                <label htmlFor="roleName" className="col-sm-3 col-form-label fw-semibold text-secondary">
                  Role Name
                </label>
              ...
              <div className="row mb-5">
                <label htmlFor="roleDescription" className="col-sm-3 col-form-label fw-semibold text-secondary">
                  Description
                </label>
                <div className="col-sm-9">
                  <textarea 
